...
```typescript
import type { CreateOrganizerTournamentRequestDto } from ''
...
} satisfies CreateOrganizerTournamentRequestDto
...
const exampleParsed = JSON.parse(exampleJSON) as CreateOrganizerTournamentRequestDto
